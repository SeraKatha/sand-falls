...
impl World {
    ...
    fn tick_chunk(chunk_index : usize, write_chunk : &mut [Cell], read_world : &[Cell]) {
        for local_index in 0..Self::CELLS_PER_CHUNK {
            ...
            // println!("{local_index} / {global_index} / {:?}", read_world[global_index]);
            write_chunk[local_index] = read_world[global_index];
        }
    ...
    pub fn tick(&mut self) {
        ...
        write_buffer[0 * Self::CELLS_PER_CHUNK] = Cell::SAND;
        write_buffer[2 * Self::CELLS_PER_CHUNK] = Cell::STONE;
        ...
        write_buffer
            ...
            .enumerate()
            .for_each(|(chunk_index, chunk)| Self::tick_chunk(chunk_index, chunk, read_buffer));
    ...
    pub fn get_chunk(&self, coord : (usize, usize)) -> &[Cell] {
        ...
        return &read_buffer[global_index..global_index+Self::CELLS_PER_CHUNK];
    }
